      ...
      for (const errorName in this.errors) {
        switch (errorName) {
          ...
          case 'pattern':
            ...
            break;
          case 'limit':
            messages.push(`A ${this.label} cannot be more than ${this.errors['limit'].limit.limit}`);
            break;
        }
      }
    }
...
export class ProductFormGroup extends FormGroup {
  constructor() {
    super({
      ...
      description: new ProductFormControl('Description', 'description', '', Validators.required),
